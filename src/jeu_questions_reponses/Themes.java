...
public class Themes {
	...
	public Themes() {		
		...
		Question question4_theme1 = new Question(4, "VF", "Facile", "Histoire", "La préhistoire débute :", liste2_theme1);		
		Question question5_theme1 = new Question(5, "RC", "Moyen", "Histoire", "La préhistoire débute :", liste1_theme1);		
		...
		Question question3_theme2 = new Question(3, "QCM", "Difficile", "Sport", "Quel footballeur a été élu Ballon d’or 2015 :", liste3_theme2);		
		Question question4_theme2 = new Question(4, "VF", "Facile", "Sport", "La France a déjà remporté une coupe du monde:", liste2_theme2);		
	    ...
	    //question1
		Question question1_theme3 = new Question(1, "RC", "Facile", "Musique", "Quel est le compositeur de la sérénade \"une petite musique de nuit\" ?", liste1_theme3); 
		// liste reponses question 2
		...
		Question question5_theme3 = new Question(5, "RC", "Moyen", "Musique", "Quel est le compositeur de la sérénade \"une petite musique de nuit\" ?", liste1_theme3);		
		...
		Theme theme4 = new Theme("Culture générale", 5, 0);
		// questions du theme4
	    ...
	    //question1
		Question question1_theme4 = new Question(1, "RC", "Facile", "Culture générale", "Quels mois successifs de la même année ont chacun 31 jours ?", liste1_theme4); 
		// liste reponses question 2
		List<String> liste2_theme4 = new ArrayList<>(); 
		liste2_theme4.add("Faux"); 
		liste2_theme4.add("Vrai"); 
		Question question2_theme4 = new Question(2, "VF", "Moyen", "Culture générale", "Le point culminant des montagnes du Jura est le Reculet", liste2_theme4);
		// liste reponses question 3
		List<String> liste3_theme4 = new ArrayList<>(); 
		liste3_theme4.add("Claude Monet"); 
		liste3_theme4.add("Paul Cézanne"); 
		liste3_theme4.add("Auguste Renoir"); 
		Question question3_theme4 = new Question(3, "QCM", "Difficile", "Culture générale", "Qui a peint le tableau Les Coquelicots (ou Coquelicots, la promenade) à Argenteuil en 1873 ?:", liste3_theme4);		
		Question question4_theme4 = new Question(4, "VF", "Facile", "Culture générale", "Le point culminant des montagnes du Jura est le Reculet", liste2_theme4);		
		Question question5_theme4 = new Question(5, "RC", "Moyen", "Culture générale", "Quels mois successifs de la même année ont chacun 31 jours ?", liste1_theme4);		
		...
		Question question3_theme5 = new Question(3, "QCM", "Difficile", "Mathématiques", "Le produit est le résultat :", liste3_theme5);		
		...
		Question question2_theme6 = new Question(2, "VF", "Moyen", "Chimie", "La masse d'un électron est négligeable en comparaison de celle d'un proton.", liste2_theme6);
		// liste reponses question 3
		List<String> liste3_theme6 = new ArrayList<>(); 
		liste3_theme6.add("l'hydrogène"); 
		liste3_theme6.add("l'azote"); 
		liste3_theme6.add("l'oxygène"); 
		Question question3_theme6 = new Question(3, "QCM", "Difficile", "Chimie", " L'élément qui est le plus présent dans la composition de l'univers est", liste3_theme6);		
		Question question4_theme6 = new Question(4, "VF", "Facile", "Chimie", "La masse d'un électron est négligeable en comparaison de celle d'un proton.", liste2_theme6);		
		...
		liste3_theme7.add("La moitié du terrain du Stade de France"); 
		Question question3_theme7 = new Question(3, "QCM", "Difficile", "Agriculture", "Un pré d'un hectare a la surface de ?", liste3_theme7);		
		...
		Question question2_theme8 = new Question(2, "VF", "Moyen", "Informatique", " Une fois l'ordinateur allumé, et que l'on se connecte à sa session, on arrive sur le bureau", liste2_theme8);
		// liste reponses question 3
		List<String> liste3_theme8 = new ArrayList<>(); 
		liste3_theme8.add("HTML (Hypertext Markup Language)"); 
		liste3_theme8.add("Java"); 
		liste3_theme8.add("C++"); 
		Question question3_theme8 = new Question(3, "QCM", "Difficile", "Informatique", "Quel est le langage informatique le plus courant utilisé pour écrire les pages web ?", liste3_theme8);		
		Question question4_theme8 = new Question(4, "VF", "Facile", "Informatique", " Une fois l'ordinateur allumé, et que l'on se connecte à sa session, on arrive sur le bureau", liste2_theme8);		
		...
		Question question2_theme9 = new Question(2, "VF", "Moyen", "Anglais", "Cuillère en anglais c'est knife:", liste2_theme9);
		// liste reponses question 3
		...
		Question question4_theme9 = new Question(4, "VF", "Facile", "Anglais", "Cuillère en anglais c'est knife:", liste2_theme9);		
		...
		Question question2_theme10 = new Question(2, "VF", "Moyen", "Jardinerie", "On ne vend que des végétaux dans les jardineries.", liste2_theme10);
		// liste reponses question 3
		List<String> liste3_theme10 = new ArrayList<>(); 
		liste3_theme10.add("En fonction des types de légumes en organisant une rotation des cultures"); 
		liste3_theme10.add("En fonction des dates de semis et/ou plantation des légumes"); 
		liste3_theme10.add("Comme bon me semble"); 
		Question question3_theme10 = new Question(3, "QCM", "Difficile", "Jardinerie", "Comment organiser les semis et plantations des légumes dans un potager ?", liste3_theme10);		
		Question question4_theme10 = new Question(4, "VF", "Facile", "Jardinerie", "On ne vend que des végétaux dans les jardineries.", liste2_theme10);		
	    ...
	    liste1_theme11.add("ohms . mètres"); 
	    //question1
		Question question1_theme11 = new Question(1, "RC", "Facile", "Electronique", "Quelle unité mesure la résistivité ?", liste1_theme11); 
		// liste reponses question 2
		...
		Question question3_theme11 = new Question(3, "QCM", "Difficile", "Electronique", "Quelle est la résistance de R1 et R2 montées en parallèle ?", liste3_theme11);		
		Question question4_theme11 = new Question(4, "VF", "Facile", "Electronique", "Une pile a trois bornes:", liste2_theme11);		
		Question question5_theme11 = new Question(5, "RC", "Moyen", "Electronique", "Quelle unité mesure la résistivité ?", liste1_theme11);		
